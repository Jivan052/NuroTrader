...
import { Send, Bot, User, Loader2, RefreshCcw, Terminal, ChevronRight, Bitcoin, BadgeCheck, TrendingUp, AlertTriangle } from "lucide-react";
...
const AgentInterface: React.FC = () => {
  ...
  const clearChat = async () => {
    ...
    if (sessionId) {
      try {
        await fetch(`http://localhost:3002/api/agent/session/${sessionId}`, {
          method: 'DELETE'
        });
        setSessionId(null);
      } catch (err) {
          ...
          <div className="mb-4 h-[600px] overflow-y-auto bg-black/20 rounded-lg p-4 border border-primary/10 backdrop-blur-sm relative">
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center relative z-10">
                ...
                <p className="text-silver/80 mb-6 max-w-md">Get expert cryptocurrency market analysis, trading insights, and portfolio recommendations powered by AI</p>
